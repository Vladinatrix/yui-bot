...
- build: Move all inline comments in spec file tags to separate lines.
* Sun Apr 20 2025 Wynona Stacy Lockwood <stacy@guppylog.com> - 1.3.17-2
- build: Move Version tag comment in spec file to its own line.
