...
def main():
    ...
    final_model_name = ""
    if args.non_interactive:
        # Use model_name_arg which is either from CLI or the default
    ...
    try:
        ...
        os.chown(temp_path, uid, gid); os.chmod(temp_path, ENV_PERMS); os.replace(temp_path, ENV_FILE)
        print(f"Successfully wrote configuration to {ENV_FILE}"); print("Final permissions:"); os.system(f"ls -l {ENV_FILE}")
